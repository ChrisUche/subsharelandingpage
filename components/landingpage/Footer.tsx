...
export const Footer = () => {
  return (
    <>
      <footer className='flex flex-col text-black-100 mt-5 mb-10 self-center w-full md:w-[1209px] rounded-3xl shadow-md shadow-[#9bd033]'>
        <div className='flex flex-col md:flex-row justify-between gap-6 px-6 py-10 sm:px-16'>
          ...
          <div className='flex flex-col'>
            <div className='footer__links flex flex-col md:flex-row gap-4 md:gap-24'>
        ...
        <div className='flex justify-center items-center flex-wrap mt-6 px-6 py-10 sm:px-16'>
