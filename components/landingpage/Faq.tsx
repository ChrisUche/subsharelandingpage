            ...
            const [selectedQuestion, setSelectedQuestion] = useState<number | null>(null);    const handleQuestionClick = (index: number) => {
                ...
                <div className="flex flex-col items-center justify-center h-screen gap-20">
                    <div className='text-center mb-5'>
                        <h2 className='font-bold text-3xl text-white  md:text-5xl'>
                    ...
                    <div >
                        {questions.map((q, index) => (
                            <div
                                ...
                                className={`cursor-pointer p-4 mb-4 rounded-lg w-[1000px] border border-custom bg-transparent ${selectedQuestion === index ? "bg-opacity-90" : ""}`}
                                >
