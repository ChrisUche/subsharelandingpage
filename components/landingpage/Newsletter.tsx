    ...
    <>
       <div className='relative bg-customgreen w-[1000px] h-[460px] self-center rounded-2xl flex items-start justify-center'>
            <div className='bg-white w-[750px] h-[300px] rounded-tl-none rounded-tr-none rounded-br-2xl rounded-bl-2xl'>
                ...
                <p className='font-normal text-sm mb-5 text-black md:text-lg'>Be the first to receive the newest updates on our product</p>
                </div>
            </div>
            <div className='flex items-center bg-black justify-center w-[420px] h-[73px] absolute rounded-2xl custom left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-[-40%]'>
                <form>
                <label>
                    <input
                    type='text'
